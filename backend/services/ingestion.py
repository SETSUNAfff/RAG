...
async def ingest_uploaded_file(
    ...
    *,
    ...
    # Parsing large PDF/DOCX files and splitting text are CPU-bound too; keep
    # them off the event loop so health/status endpoints stay responsive.
    text = await asyncio.to_thread(extract_text, file_name, data)
